...
export default function Login() {
    ...
    const handleForgotPassword = (event: React.MouseEvent<HTMLButtonElement>) => {
        ...
        router.push(`/users/password/new`, undefined, { shallow: true })
    }
                            ...
                            <FormControl fullWidth sx={{
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <FormHelperText id="forget-password-text" className="mr-0">
                                        <button onClick={handleForgotPassword}><span className="underline text-gray-500 hover:text-gray-900 text-base">Forgot your password?</span>
                                        </button>
                                    </FormHelperText>
                                </div>
                                <OutlinedInput
